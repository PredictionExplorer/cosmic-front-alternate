...
import { TransactionLink } from '@/components/features/TransactionLink';
...
export default function RoundDetailPage({ params }: { params: Promise<{ id: string }> }) {
	...
	const [activeTab, setActiveTab] = useState<'overview' | 'winners' | 'stats'>('overview');
						...
						<div className="flex items-center justify-between flex-wrap gap-4 mb-6">
							<div>
								...
								<p className="text-text-secondary">
									Completed on {formatDate(new Date(round.claimedAt * 1000))} • Duration:{' '}
									{formatDuration(round.duration * 1000)}
								</p>
							</div>

							<div className="text-right">
								<p className="text-sm text-text-secondary mb-1">Total Prize Pool</p>
				...
				<Container>
					<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
						<div className="text-center">
							...
							<p className="font-mono text-2xl font-semibold text-text-primary">{round.totalBids}</p>
						...
						<div className="text-center">
							...
							<p className="font-mono text-2xl font-semibold text-text-primary">{round.totalDonations}</p>
						...
						<div className="space-y-8">
							...
							<Card glass className="p-8 border-primary/20">
								<div className="flex items-start justify-between">
									...
									<div className="text-right">
										<p className="text-xs text-text-secondary mb-1">Prize Amount</p>
										<p className="font-mono text-4xl font-bold text-primary">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<Card glass className="p-6">
									...
									<AddressDisplay address={round.enduranceChampion} className="mb-4" />
								...
								<Card glass className="p-6">
									...
									<AddressDisplay address={round.chronoWarrior} className="mb-4" />
									<div className="flex justify-between items-center">
										<span className="text-sm text-text-secondary">Prize:</span>
										<span className="font-mono text-lg text-primary">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<Card glass className="p-6">
									...
									<div className="space-y-3">
										<div className="flex justify-between">
											<span className="text-sm text-text-secondary">ETH Winners:</span>
											<span className="text-text-primary">{round.numRaffleETHWinners}</span>
										</div>
										<div className="flex justify-between">
											<span className="text-sm text-text-secondary">NFT Winners:</span>
											<span className="text-text-primary">{round.numRaffleNFTWinners}</span>
										</div>
										<div className="flex justify-between pt-3 border-t border-text-muted/10">
											<span className="text-sm text-text-secondary">Total ETH:</span>
								...
								<Card glass className="p-6">
									...
									<div className="space-y-3">
										<div className="flex justify-between">
											<span className="text-sm text-text-secondary">To Stakers:</span>
						...
						<Card glass className="p-8">
							...
							<div className="space-y-4">
								<div className="p-4 rounded-lg bg-primary/5 border border-primary/10">
									<div className="flex justify-between items-center">
										<div>
											<p className="text-sm text-text-secondary mb-1">Main Prize</p>
											<AddressDisplay address={round.winner} />
										</div>
								...
								<div className="p-4 rounded-lg bg-background-elevated">
									<div className="flex justify-between items-center">
										<div>
											<p className="text-sm text-text-secondary mb-1">Endurance Champion</p>
								...
								<div className="p-4 rounded-lg bg-background-elevated">
									<div className="flex justify-between items-center">
										<div>
											<p className="text-sm text-text-secondary mb-1">Chrono-Warrior</p>
								...
								<div className="p-4 rounded-lg bg-background-elevated">
									<p className="text-sm text-text-secondary mb-2">Raffle Winners</p>
									<p className="text-text-primary">
										{round.numRaffleETHWinners} ETH winners + {round.numRaffleNFTWinners} NFT
										winners
									</p>
								</div>
							</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<Card glass className="p-8">
								...
								<div className="space-y-4">
									...
									<div className="flex justify-between pb-3 border-b border-text-muted/10">
										<span className="text-text-secondary">Total ETH Collected</span>
										<span className="font-mono text-primary font-semibold">
											{formatEth(round.ethCollected)} ETH
										</span>
									</div>
									<div className="flex justify-between">
										<span className="text-text-secondary">Total CST Activity</span>
										<span className="font-mono text-primary font-semibold">
							...
							<Card glass className="p-8">
								...
								<div className="space-y-3">
									{[
										...
										{ label: 'Chrono-Warrior (8%)', value: round.chronoWarriorPrize },
										...
										<div key={index} className="space-y-1">
											...
											<div className="h-2 bg-background-elevated rounded-full overflow-hidden">
												<div
													...
													style={{
														width: `${
															(parseFloat(item.value) / parseFloat(round.ethCollected)) *
															100
														}%`
													}}
												/>
