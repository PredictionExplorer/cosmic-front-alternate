				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
					...
					>
						...
						<div>
							...
							<p className="text-text-secondary">Minted on {formatDate(nft.mintedAt)}</p>
						</div>
						...
						<Card glass>
							<CardContent className="p-6 space-y-4">
								<div className="flex justify-between items-center pb-4 border-b border-text-muted/10">
									...
									<span className="font-mono text-primary font-semibold">#{nft.tokenId}</span>
								</div>
								...
								<div className="flex justify-between items-center pb-4 border-b border-text-muted/10">
									...
									<span className="font-mono text-primary">{shortenAddress(nft.owner, 6)}</span>
								</div>
						...
						<Card glass>
							<CardContent className="p-6">
								...
								<div className="space-y-4 text-sm text-text-secondary">
									<p>
										This Cosmic Signature NFT was generated using a deterministic algorithm with the
										seed value shown above. The generation process is fully transparent and
										verifiable on-chain.
									</p>
									<p>
										Each NFT is unique based on its seed, which is derived from blockchain data
										including block hashes, timestamps, and Arbitrum-specific entropy sources.
									</p>
									<a
										href="https://ipfs.io"
										target="_blank"
						...
						<Card glass>
							<CardContent className="p-6">
								<h3 className="font-serif text-xl font-semibold text-text-primary mb-4">Provenance</h3>
								<div className="space-y-3">
									<div className="flex items-start space-x-3">
										<div className="flex-shrink-0 w-2 h-2 rounded-full bg-primary mt-2" />
										<div className="flex-1">
											<p className="text-sm text-text-primary font-medium">Minted</p>
									...
									<div className="flex items-start space-x-3">
										...
										<div className="flex-1">
											<p className="text-sm text-text-primary font-medium">Current Owner</p>
											<p className="text-xs text-text-secondary font-mono">{nft.owner}</p>
										</div>
									</div>
								</div>
							</CardContent>
