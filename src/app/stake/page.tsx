			...
			<section className="section-padding bg-background-surface/50">
				<Container>
					...
					>
						...
						<p className="body-xl">
							Lock your NFTs to earn a share of {GAME_CONSTANTS.STAKING_PERCENTAGE}% of each round&apos;s
							prize pool. Withdraw anytime with accumulated rewards.
						</p>
					</motion.div>
				</Container>
			</section>
					...
					<section className="py-12">
						<Container>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
								<StatCard label="Your NFTs" value={cosmicNFTs.length} icon={Gem} />
								<StatCard label="Currently Staked" value={yourStakedCount} icon={Award} />
								<StatCard
									label="Total Rewards"
									value={`${formatEth(yourTotalRewards)} ETH`}
									icon={TrendingUp}
								/>
								<StatCard label="Reward Per NFT" value={`${formatEth(rewardPerNFT)} ETH`} icon={Zap} />
							</div>
						</Container>
					</section>
							...
							<Card glass className="p-8 md:p-12">
								...
								<div className="p-6 rounded-lg bg-background-elevated border border-text-muted/10">
									<div className="flex items-start justify-between mb-4">
										<div>
											<p className="text-sm text-text-secondary mb-1">Total Staked Globally</p>
											<p className="font-mono text-2xl font-semibold text-primary">
												{totalStaked} NFTs
											</p>
										</div>
										<div className="text-right">
											<p className="text-sm text-text-secondary mb-1">Current Reward Rate</p>
											<p className="font-mono text-2xl font-semibold text-primary">
									...
									<div className="text-xs text-text-secondary">
										Rewards update after each round ends. The more rounds that pass while
										you&apos;re staked, the more you earn. Rewards are distributed proportionally -
										if you stake 10 NFTs out of 100 total staked, you earn 10% of the staking pool
										each round.
									</div>
								</div>
							</Card>
														...
														>
															<td className="p-4">
																<div className="flex items-center space-x-3">
																	<div className="h-12 w-12 rounded bg-background-elevated overflow-hidden">
																		<img
																			src={nft.imageUrl}
																			alt={nft.name}
																			className="w-full h-full object-cover"
															...
															<td className="p-4">
																<p className="font-mono text-primary font-semibold">
																	{formatEth(rewardPerNFT * (index + 1) * 0.7)} ETH
																</p>
															</td>
															<td className="p-4">
							...
							<Card glass className="p-8 md:p-12">
								<div className="text-center mb-8">
									...
									<p className="body-lg max-w-2xl mx-auto">
										Stake Random Walk NFTs to become eligible for raffle prize drawings
									</p>
								</div>
									...
									<div className="space-y-4">
										...
										<ul className="space-y-3 text-text-secondary">
											...
											<li className="flex items-start space-x-2">
												<span className="flex-shrink-0 h-1.5 w-1.5 rounded-full bg-primary mt-2" />
												<span className="text-sm leading-relaxed">
													Each round, 4 Cosmic Signature NFTs are randomly awarded to stakers
												</span>
											</li>
											<li className="flex items-start space-x-2">
												<span className="flex-shrink-0 h-1.5 w-1.5 rounded-full bg-primary mt-2" />
												<span className="text-sm leading-relaxed">
													The more NFTs you stake, the higher your odds of winning
												</span>
											</li>
											<li className="flex items-start space-x-2">
												<span className="flex-shrink-0 h-1.5 w-1.5 rounded-full bg-primary mt-2" />
												<span className="text-sm leading-relaxed">
													Unstake anytime - no ETH rewards, just raffle eligibility
												</span>
											</li>
										</ul>
									</div>
											...
											<div className="p-4 rounded-lg bg-status-warning/10 border border-status-warning/20">
												<div className="flex items-start space-x-2">
													...
													<div className="text-sm text-text-secondary">
														...
														<p>
															Once a Random Walk NFT is staked, it can NEVER be staked
															again, even after unstaking. This is permanent.
														</p>
													</div>
												</div>
											</div>
											...
											<div className="p-4 rounded-lg bg-status-info/10 border border-status-info/20">
												<div className="flex items-start space-x-2">
													...
													<div className="text-sm text-text-secondary">
														...
														<p>
															Unlike Cosmic Signature NFT staking, Random Walk staking
															does not earn ETH rewards. The benefit is raffle eligibility
															only.
														</p>
													</div>
												</div>
											...
											<div className="p-4 rounded-lg bg-status-error/10 border border-status-error/20">
												<div className="flex items-start space-x-2">
													...
													<div className="text-sm text-text-secondary">
														...
														<p>
															If you&apos;ve used a Random Walk NFT for bidding (to get
															the 50% discount), you cannot stake it. Used NFTs are
						...
						{[
							...
							>
								<Card glass className="p-6 h-full">
									<h3 className="font-serif text-lg font-semibold text-text-primary mb-3">{faq.q}</h3>
