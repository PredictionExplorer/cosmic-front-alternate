...
export default function StakePage() {
  ...
  useEffect(() => {
    ...
    fetchStakingPercent();
  }, [contracts?.COSMIC_GAME, dashboardData]);
                ...
                <Card glass className="p-8">
                  <div className="text-center py-12">
                    ...
                    <p className="text-text-secondary mb-6">
                      Connect your wallet to view and anchor your Cosmic
                      Signature NFTs
                    </p>
                  </div>
                </Card>
              ...
              {!rwlk.isLoading && isConnected && rwlk.availableTokens.length === 0 && rwlk.stakedTokens.length === 0 && (
                <Card glass className="p-12 text-center">
                  <div className="max-w-md mx-auto">
                    ...
                    <p className="text-text-secondary mb-6">
                      You don&apos;t have anything anchored at the moment. You need to own Random Walk NFTs to anchor them for stellar selection eligibility.
                    </p>
                  </div>
                </Card>
              )}
