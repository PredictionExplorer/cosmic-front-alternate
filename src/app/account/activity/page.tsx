...
export default function MyActivityPage() {
  const [filterType, setFilterType] = useState<"all" | TimelineItem["type"]>(
    "all"
  );
  ...
  const filteredActivities =
    filterType === "all"
      ...
      : MOCK_USER_ACTIVITIES.filter((a) => a.type === filterType);
  ...
  const activityCounts = {
    ...
    other: MOCK_USER_ACTIVITIES.filter((a) =>
      ["donation", "transfer", "name-change"].includes(a.type)
    ).length,
  };
      ...
      <section className="section-padding bg-background-surface/50">
        <Container>
          ...
          >
            ...
            <p className="body-lg">
              Complete history of your actions in Cosmic Signature
            </p>
          </motion.div>
        </Container>
      </section>
