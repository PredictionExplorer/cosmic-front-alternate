...
export const rainbowKitTheme = {
	...
	custom: {
		colors: {
			...
			connectButtonInnerBackground: 'linear-gradient(135deg, #D4AF37 0%, #E5E4E2 100%)',
			connectButtonText: '#0A0A0F',
			connectButtonTextError: '#FFFFFF',
			connectionIndicator: '#10B981',
			downloadBottomCardBackground: 'linear-gradient(180deg, #14141F 0%, #0A0A0F 100%)',
			downloadTopCardBackground: 'linear-gradient(180deg, #14141F 0%, #0A0A0F 100%)',
			error: '#EF4444',
